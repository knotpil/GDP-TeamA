...
public class ChatShaderCtrl : MonoBehaviour
{
    ...
    private static readonly int ShellGravityId = Shader.PropertyToID("_GravityStrength");
    ...
    private void DrawShells()
    {
        ...
        _propBlock.SetFloat(ShellGravityId, shellGravity);
